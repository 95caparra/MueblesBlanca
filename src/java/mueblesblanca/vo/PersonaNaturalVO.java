...
public class PersonaNaturalVO {
    ...
    public PersonaNaturalVO(){
        tipoDocumentoPersonaNatural = new TipoDocumentoVO();
        ciudadPersonaNatural = new CiudadVO();
        rolPersonaNatural = new RolVO();
    }
    ...
    public void setCiudadPersonaNatural(CiudadVO ciudadPersonaNatural) {
    ...
    public void setRolPersonaNatural(RolVO rolPersonaNatural) {
