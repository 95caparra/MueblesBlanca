...
-- Volcando datos para la tabla quotevent.cliente: ~3 rows (aproximadamente)
DELETE FROM `cliente`;
...
INSERT INTO `cliente` (`n_identificacion`, `tipo_documento`, `nombre`, `apellido`, `telefono`, `celular`, `direccion`, `ciudad`, `correo`, `estado`) VALUES
	(4845454, 2, 'fgfghjklñ{', 'tyuio', '4484845', '454545', 'calle 20', 2, 'caparra', 'Activo'),
...
-- Volcando estructura para tabla quotevent.detalle_evento_empleado
DROP TABLE IF EXISTS `detalle_evento_empleado`;
CREATE TABLE IF NOT EXISTS `detalle_evento_empleado` (
  `id_detalle_evento_empleado` int(11) NOT NULL AUTO_INCREMENT,
  `id_evento` int(11) DEFAULT NULL,
  `id_empleado` bigint(20) DEFAULT NULL,
  `estado` varchar(50) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id_detalle_evento_empleado`),
  KEY `id_evento` (`id_evento`),
  KEY `id_empleado` (`id_empleado`),
  CONSTRAINT `FK_detalle_evento_empleado_empleado` FOREIGN KEY (`id_empleado`) REFERENCES `empleado` (`n_identificacion`),
  CONSTRAINT `FK_detalle_evento_empleado_evento` FOREIGN KEY (`id_evento`) REFERENCES `evento` (`id_evento`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla quotevent.detalle_evento_empleado: ~0 rows (aproximadamente)
DELETE FROM `detalle_evento_empleado`;
/*!40000 ALTER TABLE `detalle_evento_empleado` DISABLE KEYS */;
INSERT INTO `detalle_evento_empleado` (`id_detalle_evento_empleado`, `id_evento`, `id_empleado`, `estado`) VALUES
	(1, 23, 1030654523, 'Activo'),
	(2, 23, 343534534534, 'Activo');
/*!40000 ALTER TABLE `detalle_evento_empleado` ENABLE KEYS */;
...
INSERT INTO `evento` (`id_evento`, `solicitud_id_solicitud`, `cliente_id_cliente`, `tipo_evento`, `id_lugar`, `cantidad_personas`, `cantidad_meseros`, `hora_inicio`, `hora_fin`, `fecha`, `precio`, `observaciones`, `estado_evento`) VALUES
	...
	(10, 3, 11111111, 2, 1, 250, 12, '03:00:00', '23:00:00', '2018-09-28', 2500000, 'Observaciones Observaciones ', 1),
	(11, 5, 1030654523, 1, 1, 25, 11, '04:00:00', '19:00:00', '2018-09-28', 233333, 'Observaciones Observaciones ', 1),
	(12, 5, 1030654523, 1, 1, 25, 11, '04:00:00', '19:00:00', '2018-09-28', 233333, 'Observaciones Observaciones ', 1),
	(13, 4, 11111111, 1, 1, 10, 10, '04:00:00', '23:00:00', '2018-09-28', 2500000, 'Observaciones Observaciones ', 1),
	(14, 4, 1030654523, 1, 1, 10, 12, '07:00:00', '23:00:00', '2018-09-28', 2500000, 'Observaciones Observaciones ', 1),
	(15, 4, 1030654523, 1, 1, 10, 12, '07:00:00', '23:00:00', '2018-09-28', 2500000, 'Observaciones Observaciones ', 1),
	(16, 4, 1030654523, 1, 1, 10, 12, '07:00:00', '23:00:00', '2018-09-28', 2500000, 'Observaciones Observaciones ', 1),
	(17, 4, 11111111, 1, 1, 10, 23, '04:00:00', '14:00:00', '2018-09-28', 2500000, 'Observaciones Observaciones ', 1),
	(18, 4, 11111111, 1, 1, 10, 1, '06:00:00', '08:00:00', '2018-09-28', 2500000, 'Observaciones Observaciones ', 1),
	(19, 4, 1030654523, 1, 1, 10, 12, '08:31:00', '23:00:00', '2018-09-28', 2500000, 'Observaciones Observaciones ', 1),
	(20, 4, 1030654523, 1, 1, 10, 20, '05:00:00', '23:00:00', '2018-09-28', 2500000, 'Observaciones Observaciones ', 1),
	(21, 4, 1030654523, 1, 1, 10, 20, '02:00:00', '23:00:00', '2018-09-28', 2500000, 'Observaciones Observaciones ', 1),
	(22, 4, 11111111, 1, 1, 10, 23, '07:00:00', '23:00:00', '2018-09-28', 2500000, 'Observaciones Observaciones ', 1),
	(23, 4, 1030654523, 2, 1, 10, 4, '04:00:00', '21:00:00', '2018-09-28', 2500000, 'Observaciones Observaciones ', 1);
...
INSERT INTO `producto` (`id_producto`, `nombre`, `foto`, `tipo`, `cantidad`, `medida`, `precio_unidad`, `observaciones`, `estado`) VALUES
	(22, 'arroz con pollo', 'arroz-con-pollo.jpg', 1, -510, 7, 5800, 'rico arroz con pollo', 'Activo'),
...
INSERT INTO `solicitud` (`id_solicitud`, `nombre_cliente`, `cantidad_personas`, `telefono`, `email`, `id_tipo_evento`, `id_paquete`, `hora`, `fecha`, `observaciones`, `estado`, `visto`) VALUES
	(3, 'camilo', 250, '215454', 'caparra95@misena.edu.co', 1, 5, '00:00:02', '2018-09-28', 'Observaciones Observaciones ', 'Inactivo', 0),
...
-- Volcando datos para la tabla quotevent.suministro: ~11 rows (aproximadamente)
...
INSERT INTO `suministro` (`id_suministro`, `nombre`, `foto`, `cantidad`, `cantidad_minima`, `medida`, `precio_unidad`, `observaciones`, `estado`) VALUES
	...
	(18, 'prueba ws', 'arroz con pollo.jpg', 20, 10, 1, 20000, 'prueba ws', 'Activo'),
	(19, 'prueba2 ws', 'pollo.jpg', 20, 10, 1, 5000, 'prueba 2 ws', 'Activo');
