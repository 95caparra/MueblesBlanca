...
CREATE TABLE IF NOT EXISTS `detalle_paquete_producto` (
  ...
  CONSTRAINT `FK_detalle_paquete` FOREIGN KEY (`id_paquete`) REFERENCES `paquete` (`id_paquete`),
  CONSTRAINT `FK_detalle_producto` FOREIGN KEY (`id_producto`) REFERENCES `producto` (`id_producto`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

-- Volcando datos para la tabla quotevent.detalle_paquete_producto: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla quotevent.detalle_producto_suministro: ~6 rows (aproximadamente)
...
-- Volcando datos para la tabla quotevent.paquete: ~4 rows (aproximadamente)
DELETE FROM `paquete`;
...
INSERT INTO `paquete` (`id_paquete`, `nombre`, `clasificacion`, `descripcion`, `lugar`, `cantidad_personas`, `precio`, `pdf`, `foto`, `estado`) VALUES
	...
	(2, 'sdasd', 1, 'asdas', 1, 12, 12, 'logo 5.png', 'logo 5.png', 'Activo'),
	(3, 'paquete matrimonio', 1, 'matricidio', 1, 20, 2500000, 'matrimonio.jpg', 'matrimonio.jpg', 'Activo'),
	(4, 'matrimonio', 2, 'asdsd', 1, 12, 12, 'matrimonio.jpg', 'matrimonio.jpg', 'Activo');
...
-- Volcando datos para la tabla quotevent.producto: ~7 rows (aproximadamente)
DELETE FROM `producto`;
/*!40000 ALTER TABLE `producto` DISABLE KEYS */;
INSERT INTO `producto` (`id_producto`, `nombre`, `foto`, `tipo`, `cantidad`, `medida`, `precio_unidad`, `observaciones`, `estado`) VALUES
	(1, 'Arroz Con Leche', 'arroz-con-leche.jpg', 1, 10, 7, 3000, 'bueno', 'Activo'),
	(2, 'Vino Tinto', 'arroz-con-leche.jpg', 2, 15, 3, 20000, 'rico', 'Activo'),
	(3, 'Mesa decoracion', 'arroz-con-leche.jpg', 3, 10, 1, 200000, 'elegantes', 'Activo'),
	(16, 'vino añejo', 'arroz-con-leche.jpg', 2, 10, 1, 20000, 'nose', 'Activo'),
	(17, 'arroz con leche', 'arroz-con-leche.jpg', 1, 20, 7, 2500, 'Observaciones', 'Activo'),
	(18, 'Arroz con leche', 'arroz-con-leche.jpg', 1, 20, 7, 2500, 'Observaciones', 'Activo'),
	(19, 'arroz con pollo', 'arroz-con-leche.jpg', 1, 25, 1, 20000, 'Observaciones', 'Activo'),
	(20, 'arroz con leche', 'arroz con leche.jpg', 1, 25, 7, 2900, 'arroz rico', 'Activo');
...
-- Volcando datos para la tabla quotevent.suministro: ~8 rows (aproximadamente)
...
INSERT INTO `suministro` (`id_suministro`, `nombre`, `foto`, `cantidad`, `cantidad_minima`, `medida`, `precio_unidad`, `observaciones`, `estado`) VALUES
	(1, 'Arroz', 'arroz.jpg', 20, 10, 1, 2000, 'arroz diana', 'Activo'),
	(2, 'Arroz', 'arroz.jpg', 30, 10, 4, 2500, 'leche deslactosada', 'Activo'),
	(3, 'Arroz', 'arroz.jpg', 20, 50, 2, 2000, 'arrocito', 'Activo'),
	(4, 'Arroz', 'arroz.jpg', 20, 50, 1, 2500, 'Observaciones', 'Activo'),
	(5, 'arroz', 'arroz.jpg', 80, 50, 1, 2500, 'Observaciones', 'Activo'),
	(6, 'arroz', 'arroz.jpg', 80, 50, 1, 3500, 'Observaciones', 'Activo'),
	(7, 'arroz', 'arroz.jpg', 50, 25, 1, 2800, 'Observaciones', 'Activo'),
	(8, 'leche', 'leche.jpg', 50, 25, 4, 2800, 'Observaciones', 'Activo');
