...
-- Volcando datos para la tabla quotevent.cliente: ~4 rows (aproximadamente)
DELETE FROM `cliente`;
...
INSERT INTO `cliente` (`n_identificacion`, `tipo_documento`, `nombre`, `apellido`, `telefono`, `celular`, `direccion`, `ciudad`, `correo`, `estado`) VALUES
	(3423423, 1, 'dasdas ', 'dasdas', '423423423', '23423423', 'dasdasdas', 2, 'caparra95@misena.edu.co', 'Activo'),
	(4845454, 2, 'fgfghjklñ{', 'tyuio', '4484845', '454545', 'calle 20', 2, 'caparra95@misena.edu.co', 'Activo'),
...
-- Volcando datos para la tabla quotevent.producto: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla quotevent.rol: ~1 rows (aproximadamente)
DELETE FROM `rol`;
...
-- Volcando datos para la tabla quotevent.suministro: ~0 rows (aproximadamente)
