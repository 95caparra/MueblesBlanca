...
-- Volcando datos para la tabla quotevent.detalle_paquete_producto: ~6 rows (aproximadamente)
...
-- Volcando datos para la tabla quotevent.detalle_producto_suministro: ~4 rows (aproximadamente)
...
-- Volcando datos para la tabla quotevent.producto: ~2 rows (aproximadamente)
DELETE FROM `producto`;
/*!40000 ALTER TABLE `producto` DISABLE KEYS */;
INSERT INTO `producto` (`id_producto`, `nombre`, `foto`, `tipo`, `cantidad`, `medida`, `precio_unidad`, `observaciones`, `estado`) VALUES
	(22, 'arroz con pollo', 'arroz-con-pollo.jpg', 1, 20, 7, 5800, 'rico arroz con pollo', 'Activo'),
...
-- Volcando datos para la tabla quotevent.solicitud: ~2 rows (aproximadamente)
...
INSERT INTO `solicitud` (`id_solicitud`, `nombre_cliente`, `cantidad_personas`, `telefono`, `email`, `id_tipo_evento`, `id_paquete`, `hora`, `fecha`, `observaciones`, `estado`, `visto`) VALUES
	(3, 'camilo', 250, '215454', 'caparra95@misena.edu.co', 1, 5, '2 pm', '2018-09-28', 'Observaciones Observaciones ', 'Activo', 0),
	(4, 'andres', 10, '2315445', 'caparra95@misena.edu.co', 1, 5, '3 pm ', '2018-09-28', 'Observaciones Observaciones ', 'Activo', 0),
...
-- Volcando datos para la tabla quotevent.suministro: ~3 rows (aproximadamente)
